...
fun NoVideoFoundView(
    ...
    message: String = "No Video Files Found",
    description: String = "We couldn't find any video files on your device.",
    onRefresh: (() -> Unit)? = null
) {
    Column(
        modifier = modifier
...
@Composable
private fun NoVideoFoundViewPreview() {
    TimbreAssignmentTheme {
        NoVideoFoundView(onRefresh = {})
    }
}
